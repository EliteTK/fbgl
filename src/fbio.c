...
// Get the value of the next block to draw to the framebuffer.
size_t fbgl_get_next_block(size_t *inc_addr)
{
...
{
    size_t *block = malloc(sizeof(size_t));
    *block = 0;
...
// Fill the buffer fb with colour value RGBA.
